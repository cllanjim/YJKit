...
- (BOOL)support4K       { return iOS_Version >= 9.0 ? [self canSetSessionPreset:AVCaptureSessionPreset3840x2160] : NO; }
...
- (void)set4K       { if (iOS_Version >= 9.0) self.sessionPreset = AVCaptureSessionPreset3840x2160; };
